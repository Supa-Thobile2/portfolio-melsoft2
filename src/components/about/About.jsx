...
function About() {
  ...
  return (
    ...
    <>
       <div className='rounded-3xl flex justify-center items-center flex-col h-[100vh] px-8 mb-6 shadow-lg border-2 md:flex-row  '>
        
            <img src={Image} alt="astranaut"  className='w-70 mx-auto rounded-4xl object-contain' />
        ...
        <div className=' md: mx-auto text-center'>
              ...
              <div className='py-1 mx-2'>
                  <p className='text-start text-[8px] tracking-wide leading-4 text-white my-2 md:text-center'>I wrote my first line of code in 2019—and unlike most things I tried that year, I actually stuck with it. Since then, I’ve been deep in the trenches of syntax, semicolons, and stack traces, turning coffee into code and bugs into (eventual) features.</p>
              <p className='text-start text-[8px] tracking-wide leading-4 text-white pb-2 md:text-center'>What started as a curiosity quickly evolved into a full-blown passion, and now I build clean, efficient, and occasionally magical software solutions. Whether it’s front-end finesse, back-end wizardry, or just wrestling with version control, I’m always up for a challenge—as long as it doesn’t involve Internet Explorer.</p>
              </div>
