...
function About() {
  ...
  return (
    ...
    <>
       <div className='rounded-3xl  md:flex justify-center items-center p-6'>
        ...
        <div className='p-2 md:p-10 mx-auto text-center px-8'>
              ...
              <p className='text-start tracking-wide leading-6 text-white py-2 md:text-center'>What started as a curiosity quickly evolved into a full-blown passion, and now I build clean, efficient, and occasionally magical software solutions. Whether it’s front-end finesse, back-end wizardry, or just wrestling with version control, I’m always up for a challenge—as long as it doesn’t involve Internet Explorer.</p>
