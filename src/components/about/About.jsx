...
function About() {
  ...
  return (
    ...
    <>
       <div className='rounded-3xl h-[100vh] md:flex justify-center items-center p-6 my-20'>
        ...
        <div className=' md: mx-auto text-center'>
              ...
              <p className='text-start text-[12px] tracking-wide leading-6 text-white py-2 md:text-center'>What started as a curiosity quickly evolved into a full-blown passion, and now I build clean, efficient, and occasionally magical software solutions. Whether it’s front-end finesse, back-end wizardry, or just wrestling with version control, I’m always up for a challenge—as long as it doesn’t involve Internet Explorer.</p>
                ...
                <div className='flex justify-evenly items-center w-full gap-2 my-3 '>
                  <button className='flex justify-evenly items-center gap-2  py-2 px-8 bg-blue-200 rounded-3xl gap-2 outline-0 border hover:translate-y-[10px] hover:shadow-md transition duration-300'> <FaEnvelope/>Contact Me</button>
                  <button className='flex justify-evenly items-center gap-2  py-2 px-8 bg-blue-200 rounded-3xl gap-2 hover:translate-y-[10px] hover:shadow-md transition duration-300'>  <FaFileDownload/>Hire Me</button>
