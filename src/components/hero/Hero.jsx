...
function Hero() {
  ...
  return (
    ...
    <>
        ...
        <div className=' flex items-center justify-center flex-col mx-auto w-100vw h-[100vh] text-center border-2 my-10 '>
               
                        <img src={Image}  alt='astranaut image' className='w-35 rounded-full border-2 shadow-lg mx-auto  md:mx-auto' />
                 
                      
                      
                        <h1 className='text-[24px] text-white'>Thobile Nontenja</h1>
                        <span className='text-white text-[14px] '>Full Stack Developer</span>
                  ...
                  <div className='w-full  flex items-center justify-center flex-col px-4 py-2 mx-10 my-1'>
                    <p className='text-[8px] pb-2 tracking-wide text-white  md:text-center '>Hey there! It's a me Thobile Nontenja, a software engineer based in South Africa with a passion for building innovative digital solutions.
                       </p>
                    <p className='text-[8px] pb-2 text-white tracking-wide'>Since starting my coding journey in 2019, I've developed a strong foundation in front-end development, with expertise in HTML, CSS, and JavaScript.</p>
                    <span className='text-[8px]  tracking-wide text-white italic bold'>'First rule at Melsoft club: Talk about code. The second rule of the melsoft club: You don't think about Errors'</span>
                  </div>
