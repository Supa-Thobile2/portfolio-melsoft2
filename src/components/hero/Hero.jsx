  ...
  return (
    ...
    <>
        ...
        <div className=' flex items-center justify-center flex-col mx-auto w-full h-full mt-14 text-center p-4 mb-4 '>
                        ...
                        <img src={Image}  alt='astranaut image' className='w-40 rounded-full shadow-lg mx-auto mb-2 md:mx-auto' />
                 
                      
                      
                        <h1 className='text-2xl text-white my-1 md:text-4xl lg:text-3xl '>Thobile Nontenja</h1>
                        <span className='display-6 text-white  py-1  md:text-base lg:text-base'>Full Stack Developer</span>
                  ...
                  <div className='container items-center px-4 my-4'>
                    ...
                    <p className='text-white tracking-wide leading-7 text-start   md:text-center pt-2 lg:text-base'>Since starting my coding journey in 2019, I've developed a strong foundation in front-end development, with expertise in HTML, CSS, and JavaScript.</p>
                  ...
                  <div className='flex items-center justify-between gap-4 my-4 p-2'>
